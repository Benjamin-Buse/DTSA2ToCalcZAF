    ...
    for z in range(0,len(tables)):
        for x in tables[z].columns:
            ...
            for y in range(0,len(tables[z])):
                ...
                #print(x)
                #print(y)
                if standardselectionname[q] == str(tables[z][x][y]):
                    print("z")
                    print(z)
                    print('q')
                    print(q)
...
for i in range(0,len(ExperimentName)):
    ...
    for ii in range(0,len(eval('El'+str(i)))):
        try:
            #find standard
            print(eval('El'+str(i))[ii][2:])
            if eval('El'+str(i))[ii][2:].replace(" ","") == 'K-L3':
                #Ka line
                print("Ka line")
                ...
                print(stdcations)
                print(stdoxygens)
                stdkratio=(sum(eval('ElG'+str(i)+'_'+str(ii)))/sum(eval('ElG'+str(standardexperimentnum[elementstandard.index(eval('El'+str(i))[ii][:2])])+'_'+str(eval('El'+str(standardexperimentnum[elementstandard.index(eval('El'+str(i))[ii][:2])])).index(eval('El'+str(i))[ii])))))
                print(stdkratio)
